...
export default function Index(item) {
    ...
    return (
        <div className={styles.imageComputer} style={{backgroundColor:item.item.bgColor}} data-scroll-section>
            <div className={styles.container}>
                <div className={styles.row}>
                    <div className={styles.flexCol}>
                        <div className={styles.imageLaptop}>
                            <img className={styles.computerBorder} src="/images/computer.png" alt="" />
                            {
